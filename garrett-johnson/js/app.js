...
function displayPics(){
  ...
  // Declaring a variable using const limits the scope of the variable from being the entire block function to just the code block of the while loops. So when it was console logged it wasn't defined since the console log was outside of its scope.
  console.log(viewed)
